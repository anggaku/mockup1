        ...
        <div class="uc-mobile-menu-pusher">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2">
                                <ul class="social-icon">
                                    <li>
                                        <a href="http://facebook.com/dpmptspkaltim" class="fa fa-facebook" aria-hidden="true"> </a>
                                    </li>
                                    <li>
                                        <a href="http://twitter.com/dpmptsp_kaltim" class="fa fa-twitter" aria-hidden="true"> </a>
                                    </li>
                                    <li>
                                        <a href="http://instagram.com/dpmptsp.kaltim" class="fa fa-instagram" aria-hidden="true"> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.youtube.com/channel/UCWLgYECJfKV-i72VCF7_SBQ/videos" class="fa fa-youtube-play" aria-hidden="true"> </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-10">
                                <ul class="top-contact pull-right">
                                    <li class="phone"><i class="fa fa-phone" aria-hidden="true"></i> Telepon: (0541) 743235</li>
                                    <li class="email"><i class="fa fa-envelope-o" aria-hidden="true"></i> dpmptsp.kaltim@gmail.com</li>
                                    <li class="location"><i class="fa fa-map-marker" aria-hidden="true"></i> Jl. Basuki Rahmat No.56 Samarinda 75112</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <span class="icon-bar"></span>
                            ...
                            <a class="navbar-brand" href="index.html"><img src="img/logodpmpmst.png" style="height: 40px;" alt=""></a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="#navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right main-nav">
                                ...
                                <!-- <li class="dropdown dropdown-toggle"><a href="#" data-toggle="dropdown">Kegiatan <span><i class="fa fa-angle-down"></i></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Kegiatan & Kinerja</a></li>
                                        <li><a href="#">Laporan & Capaian Kinerja</a></li>
                                        <li><a href="#">Program Legislasi Daerah</a></li>
                                    </ul>
                                </li> -->
                                <!-- <li class="dropdown dropdown-toggle"><a href="#" data-toggle="dropdown">Agenda <span><i class="fa fa-angle-down"></i></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Rapat Kerja</a></li>
                                        <li><a href="#">Pameran</a></li>
                                    </ul>
                                </li> -->
                                <li><a href="services.html">Detail</a></li>
                                <li><a href="services.html">Pengaduan</a></li>
                                <li><a href="login.html" class="btn btn-primary btn-perizinan">Pendaftaran Izin</a></li>
                            </ul>
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item">
                            ...
                            <!-- <div class="carousel-caption">
                                ...
                                <p>Monotonectally envisioneer 24/7 bandwidth with reliable imperatives. <br>Continually unleash unique niches after go forward.</p>
                            </div> -->
                        </div>
                        <div class="item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="footer-text">
                                        <p>Assertively architect synergistic platforms vis-a-vis premium results. Synergistically facilitate high-payoff e-services rather than top-line sources. Collaboratively drive market positioning infomediaries without
                                            real-time e-commerce.</p>
